...
// iniciar o cyper: npx cypress open
...
mocha -> lib adicional para execução dos testes em conjunto das bibliotecas mochawesome, mochawesome-merge e mochawesome-report-generator
mochawesome -> biblioteca responsável por gerar os arquivos json com informações dos testes realizados para ser utilizados nos relatórios
                 * para cada arquivo spec é gerado um arquivo json
...
rimraf -> comando rm -rf para o node, utilizado para limpar a pasta

npm install -D cypress-multi-reporters mocha mochawesome mochawesome-merge mochawesome-report-generator -y
